...
namespace WebApp.Controllers
{
    ...
    public class StepController : Controller
    {
        ...
        public StepController(ICompanyManager company, IOperatorManager _operator, ITariffManager tariff,
        ...
        public IActionResult Operators(int companyId)
        {
            ...
            model.OperatorModel.OperatorsList = operatorManager.GetAll();
            ViewData["companyId"] = companyId;
            return View(model);
        }
        ...
        [HttpGet]
        public List<TariffViewModel> Tariffs(int id, int companyId)
        {
